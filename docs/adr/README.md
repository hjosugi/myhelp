...
| [0004](0004-opt-in-git-vault-sync.md) | Accepted | Offer opt-in, per-vault Git sync through the installed `git` with no credential handling or destructive operations |
